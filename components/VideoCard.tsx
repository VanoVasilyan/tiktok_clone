        ...
        <div className='flex flex-col border-b-2 border-gray-200 pb-6'>
            <div>
                <Link href={`/profile/${post.postedBy._id}`}>
                    <div className='flex gap-3 p-5 cursor-pointer font-semibold rounded'>
                ...
                <div
                    ...
                    {isHover && (
                        <div className='absolute bottom-6 cursor-pointer left-8 md:left-14 lg:left-0 flex gap-10 lg:justify-between w-[100px] md:w-[50px] p-3'>
                            {playing ? (
                                <button><BsFillPauseFill onClick={onVideoPress} className='text-black text-2xl lg:text-4xl' /></button>
                            ) : (
                                <button><BsFillPlayFill onClick={onVideoPress} className='text-black text-2xl lg:text-4xl' /></button>
                            )}
                            {isVideoMuted ? (
